...
const fakeTurmas = [
  { id: 1, cursoId: 1, turno: 'manha', periodoAtual: 1, quantidadeAlunos: 30, ano: 2025 },
  { id: 2, cursoId: 1, turno: 'tarde', periodoAtual: 1, quantidadeAlunos: 25, ano: 2025 },
];
...
describe('TurmaService', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    service = new TurmaService(mockRepository as any);
  });
